...
execute_process(
  COMMAND "/usr/bin/git" show-ref "v1.15.0"
  WORKING_DIRECTORY "/home/parallels/Developer/MIG-Bot/CPP/Platform/Workspace/HelloWorld/build/_deps/googletest-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/parallels/Developer/MIG-Bot/CPP/Platform/Workspace/HelloWorld/build/_deps/googletest-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/parallels/Developer/MIG-Bot/CPP/Platform/Workspace/HelloWorld/build/_deps/googletest-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
